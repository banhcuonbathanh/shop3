...
import { deleteImageControllerProduct } from "../controller";
...
export const CellActionProduct: React.FC<CellActionProps> = ({ data }) => {
  ...
  const onConfirm = async () => {
    console.log("this is delete in product cell actio n", data.imageUrls);
    try {
      setLoading(true);
      await axios.delete(
      ...
      await deleteImageControllerProduct(data.imageUrls);
