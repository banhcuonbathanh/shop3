...
import { createBlogCategory } from "../../../blog-controller/controller";
...
export const BlogCategoryForm: React.FC<BlogCategoryFormProps> = ({
  initialData
}) => {
  ...
  const onSubmit = async (data: CategoryFormValues) => {
    try {
      ...
      if (initialData) {
        ...
        console.log(
          "admin/app/(route)/blog/categories/[categoryId]/components/blog-category-form.tsx"
        );
      ...
      {initialData && (
        <div>
          <div className="flex items-center mb-4">
            <div>Category Name : {initialData.Title}</div>
