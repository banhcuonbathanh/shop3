...
//     err := p.Db.Exec(`
//     ALTER TABLE products ADD CONSTRAINT fk_products_size_id
...
return products, nil
    ...
    // err := p.Db.Model(&model.Product{}).Preload("Category").Preload("Color").Preload("Size").Find(&products).Error
    // return users, err
    ...
    // fmt.Println("FindAll repository: Fetched products:")
