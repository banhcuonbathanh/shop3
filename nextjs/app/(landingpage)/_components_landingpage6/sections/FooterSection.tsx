    ...
    <section>
      <div className="flex flex-col md:flex-row justify-between gap-8 ">
        <div>
          <p>
            <Image
              src="/images_landingpage6/logo-bottom.png"
              alt="footer logo"
              width={200}
              height={500}
        ...
        <div className="flex flex-col gap-4 items-center">
          <div className="flex gap-4 items-center">
            <Image
              src="/images_landingpage6/facebook-icon.png"
              alt="social icon"
              width={200}
              height={500}
              style={{ width: "auto", height: "auto" }}
            />
            <Image
              src="/images_landingpage6/instagram-icon.png"
              alt="social icon"
              width={200}
              height={500}
              style={{ width: "auto", height: "auto" }}
            />
            <Image
              src="/images_landingpage6/x-icon.png"
              alt="social icon"
              width={200}
              height={500}
              style={{ width: "auto", height: "auto" }}
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="bg-lightBlack rounded-extraLarge px-[1.06rem] py-[0.58rem] w-[11rem]">
              <div className="flex gap-4 items-center">
                <div>
                  <Image
                    src="/images_landingpage6/google-play-icon.png"
            ...
            <div className="bg-lightBlack rounded-extraLarge px-[1.06rem] py-[0.58rem] w-[14rem]">
              <div className="flex gap-4 items-center">
                <div>
                  <Image
                    src="/images_landingpage6/app-icon.png"
                    alt="google play icon"
                    width={200}
                    height={500}
                    style={{ width: "auto", height: "auto" }}
