...
export const linkCustomer = {
  ...
  routes_blog_categories: {
    // Get all blog categories (potentially with pagination and filtering)
    findAllBlogCategories: {
      ...
      options: {
        ...
        filtering: {
          supportedFields: ["name", "description", "createdAt", "updatedAt"] // Adapt supported fields as needed
        }
      }
    },
